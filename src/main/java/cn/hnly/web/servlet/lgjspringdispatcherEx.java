...
public class lgjspringdispatcherEx extends HttpServlet // 第一步： 扩展 HttpServlet 抽象类。
{
	 ...
	 public void init(ServletConfig config) throws ServletException 
	  ...
	  public void Springinit(ServletConfig config) throws ServletException 
	  {
		 // MyApplication 
		 //MyApplicationContext = new AnnotationConfigApplicationContext(Application.class);
		 
		  System.out.println("Spring initConfig......");//测试语句,输出到Tomcat启动界面		  
	     ...
	     // printer.OutMessage("李庚君!ABC...YES");//测试语句
		  ...
		  config.getServletContext().setAttribute("MySpring", MyApplicationContext);
   ...
   {
       //第三步：获取HTTP 请求中的参数信息
	   ApplicationContext MyApplicationContext=(ApplicationContext)this.getServletContext().getAttribute("MySpring");
